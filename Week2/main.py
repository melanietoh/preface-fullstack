...
for loop in range(1, post_num+1):
    ...
    if loop == 1:
        action = ActionChains(driver)
        # action.double_click(driver.find_element(By.XPATH, '/html/body/div[6]/div[2]/div/article/div/div[1]/div/div[1]/div[2]/div/div/div/button'))
        ...
        driver.find_element(By.XPATH, '/html/body/div[6]/div[1]/div/div/div/button').click()
        time.sleep(2)
    else:
        action = ActionChains(driver)
        action.double_click(driver.find_element(By.XPATH, '/html/body/div[6]/div[3]/div/article/div/div[2]/div/div/div[2]/section[1]/span[1]/button'))
